...
export default class FS {
    ...
    writeSync(fd, arg2, arg3, arg4, arg5) {
        let buffer; let offset = 0; let length; let position;
        if (typeof arg2 === "string") {
    ...
    read(fd, arg2, arg3, arg4, arg5, cb = nopCb) {
        let position; let offset; let length; let buffer; let newCb;
    ...
    readSync(fd, arg2, arg3, arg4, arg5) {
        ...
        let buffer; let offset; let length; let position; let encoding = "utf8";
        if (typeof arg2 === "number") {
            length = arg2;
            position = arg3;
            encoding = arg4;
