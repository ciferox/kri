...
export default class Stats {
    ...
    static fromBuffer(buffer) {
        const size = buffer.readUInt32LE(0); const mode = buffer.readUInt32LE(4); const atime = buffer.readDoubleLE(8); const mtime = buffer.readDoubleLE(16); const ctime = buffer.readDoubleLE(24);
